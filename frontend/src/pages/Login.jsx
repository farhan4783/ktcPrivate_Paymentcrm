  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-[#F8F9FC] font-inter overflow-hidden">
      ...
      >
        ...
        {/* Floating shapes animation style */}
      ...
      <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col items-center justify-center p-8 md:p-12 lg:p-20 bg-[#F8F9FC] relative">
        ...
        <motion.div 
          ...
          className="w-full max-w-[360px] bg-white p-5 md:p-6 rounded-[1.5rem] shadow-premium"
        >
          <div className="hidden md:block mb-6 text-left">
            <h2 className="text-2xl font-bold text-textPrimary mb-1">Hello! Welcome Back</h2>
            <p className="text-textSecondary font-medium">Login to your account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  type="email"
                  required
                  className="w-full pl-11 pr-4 py-2.5 bg-gray-50 border border-[#0EA5E9]/20 rounded-xl text-textPrimary focus:bg-white focus:ring-2 focus:ring-[#0EA5E9]/20 focus:border-[#0EA5E9] outline-none transition-all placeholder:text-gray-400 text-sm"
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-[#0EA5E9] hover:bg-[#0EA5E9]/90 text-white font-bold py-3 rounded-xl shadow-lg shadow-[#0EA5E9]/20 transition-all flex items-center justify-center gap-2 group relative overflow-hidden text-sm"
            >
              {loading ? (
          ...
          <div className="mt-6 text-center">
            <p className="text-textSecondary font-medium">
              ...
              <Link to="/signup" className="text-[#0EA5E9] hover:underline font-bold transition-colors">
                Create Account
              </Link>
            </p>
          </div>
